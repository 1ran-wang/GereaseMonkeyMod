// ==UserScript==
// Original Author: https://github.com/xcanwin/KeepChatGPT/
...
`;
    ...
    const loadKCG = function() {
        ...
        ndivkcg._symbol1_innerHTML = `<img src='${icon}' style='width: 1rem;' />Yiran W`;
        ndivkcg._symbol2_innerHTML = `GPT mod`;
